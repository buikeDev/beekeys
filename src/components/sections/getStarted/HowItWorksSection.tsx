...
export const HowItWorksSection: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-white-50">
      <div className="max-w-7xl flex flex-col justify-center  px-4 sm:px-6 lg:px-8">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className=" mb-16 lg:w-[400px] px-8"
        >
          <p className="text-sm text-gray-600 max-w-2xl mx-auto">How We Work</p>
